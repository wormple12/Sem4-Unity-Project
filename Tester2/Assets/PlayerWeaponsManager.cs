...
public class PlayerWeaponsManager : MonoBehaviour {
    ...
    PlayerWalkController m_PlayerWalkController;
    ...
    void UpdateWeaponBob () {
        if (Time.deltaTime > 0f) {
            ...
            if (m_PlayerWalkController.isGrounded) {
                characterMovementFactor = Mathf.Clamp01 (playerCharacterVelocity.magnitude / (m_PlayerWalkController.maxSpeedOnGround * m_PlayerWalkController.sprintSpeedModifier));
            }
